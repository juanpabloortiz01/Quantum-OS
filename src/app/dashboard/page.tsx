                              ...
                              hourRes.map((res) => (
                                ...
                                >
                                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                                    ...
                                    <div className="flex items-center gap-2 text-[10px] md:text-xs flex-shrink-0">
                                      ...
                                      <button
                                        ...
                                        className="p-1.5 bg-rose-50 text-rose-600 border border-rose-100 rounded-lg hover:bg-rose-100 ml-1"
                                      >
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-400 leading-relaxed pt-0.5">
                      Ejemplo: si tu local tiene capacidad para 50 personas por hora y alrededor de 20 llegan sin reserva, ingresa <strong className="text-gray-600">30</strong>.
                    </p>
                  </div>
                  <input
                    type="number"
